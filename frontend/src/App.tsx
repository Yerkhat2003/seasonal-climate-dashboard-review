...
function App() {
  ...
  return <main className="app-shell">
    ...
    <section className="cluster-overview panel">
      ...
      <div className="timeline-caption"><span className="legend-warm" /> Тёплый сезон: средний период, когда недельная температура не выше 5 °C</div>
    ...
    <section className="faq panel" id="faq">
      ...
      <div className="faq-list">
        ...
        <details><summary>Как именно считаются границы тёплого сезона?</summary><p>Весенняя граница появляется после двух последовательных недель со средней температурой не выше 5 °C. Осенняя граница определяется как последняя из двух последовательных таких недель. Затем даты усредняются по историческим годам. Такое правило снижает влияние одиночного краткого потепления или похолодания.</p></details>
